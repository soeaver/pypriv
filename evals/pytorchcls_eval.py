...
import models.imagenet as customized_models    # import from pytorch-priv
from utils import weight_filler    # import from pytorch-priv
...
parser.add_argument('--arch', type=str,
                    default='resnet50_1x64d',
                    help='model arch')
parser.add_argument('--model_weights', type=str,
                    default='./pytorch-model/resnet50-1x64d.pth.tar',
                    help='model weights')
...
PIXEL_MEANS = np.array([0.5, 0.5, 0.5])
PIXEL_STDS = np.array([0.5, 0.5, 0.5])
# ---------------------------------------------------
